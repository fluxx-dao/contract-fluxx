/**
 * 🚀 Criar Pool FLUXX/USDC - Amounts Reduzidos
 * 
 * Versão com amounts reduzidos para evitar overflow em uint128.
 * 
...
// ============================================
// CONFIGURAÇÃO (AMOUNTS REDUZIDOS)
// ============================================
...
async function main() {
  console.log("🚀 Gerando calldatas para criar Pool FLUXX/USDC (AMOUNTS REDUZIDOS)\n");
  ...
  console.log(`   ⚠️  AMOUNTS REDUZIDOS para evitar overflow!\n`);
  ...
  console.log("✅ Calldatas prontos (com amounts reduzidos para evitar overflow)!");
  console.log("\n📚 Documentação: docs/guides/RESOLVER_OVERFLOW_UINT128.md");
}
